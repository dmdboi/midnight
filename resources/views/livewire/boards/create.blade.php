...
new class extends Component {
    ...
    public function createBoard()
    {
        ...
        // Check if the board already exists in the category
        if (Board::query()->where('slug', $slug)->exists()) {
            session()->flash('error', 'Board with this name already exists in this category.');
            return;
        }
